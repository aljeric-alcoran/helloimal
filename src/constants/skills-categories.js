export const SKILL_CATEGORIES = [
   {
      category: 'Frontend',
      items: [
         { label: 'TypeScript', src: '/img/typescript.webp', alt: 'TypeScript', glow: 'rgba(59,130,246,0.75)'  },
   ...
   },
   {
      ...
      items: [
         ...
         { label: 'Express', src: '/img/express.webp', alt: 'Express', glow: 'rgba(255,255,255,0.5)'  },
   ...
   },
   {
      ...
      items: [
         ...
         { label: 'Git', src: '/img/git.webp', alt: 'Git', glow: 'rgba(239,68,68,0.75)'   },
         { label: 'Docker', src: '/img/docker.webp', alt: 'Docker', glow: 'rgba(59,130,246,0.75)'  },
         { label: 'Figma', src: '/img/figma.webp', alt: 'Figma', glow: 'rgba(162,89,247,0.75)'  },
         { label: 'VS Code', src: '/img/vscode.webp', alt: 'VS Code', glow: 'rgba(59,130,246,0.75)'  },
      ],
   },
];