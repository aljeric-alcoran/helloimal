   ...
   <div class="max-w-screen-xl mx-auto p-8 md:py-16 text-gray-900 dark:text-white">
      ...
      <div class="flex items-start mt-10 gap-6">
         <div class="group flex flex-col items-center gap-1 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-700 py-4 w-[9rem] rounded-sm">
            ...
            <label for="html" class="text-sm">HTML5</label>
         </div>
         <div class="group flex flex-col items-center gap-1 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-700 py-4 w-[9rem] rounded-sm">
            ...
            <label for="css" class="text-sm">CSS3</label>
         </div>
         <div class="group flex flex-col items-center gap-1 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-700 py-4 w-[9rem] rounded-sm">
            ...
            <label for="tailwind" class="text-sm">Tailwindcss</label>
         </div>
      </div>

      <div class="flex items-start mt-[1.5rem] gap-6">
         <div class="group flex flex-col items-center gap-1 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-700 py-4 w-[9rem] rounded-sm">
            ...
            <label for="vite" class="text-sm">Vite</label>
         </div>
         <div class="group flex flex-col items-center gap-1 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-700 py-4 w-[9rem] rounded-sm">
            ...
            <label for="wordpress" class="text-sm">Wordpress</label>
         </div>
         <div class="group flex flex-col items-center gap-1 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-700 py-4 w-[9rem] rounded-sm">
            ...
            <label for="nodejs" class="text-sm">NodeJS</label>
         </div>
      </div>
      ...
      <div class="flex items-start mt-[1.5rem] gap-6">
         <div class="group flex flex-col items-center gap-1 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-700 py-4 w-[9rem] rounded-sm">
            ...
            <label for="javascript" class="text-sm">Javacsript</label>
         </div>
         <div class="group flex flex-col items-center gap-1 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-700 py-4 w-[9rem] rounded-sm">
            <img id="angular" src="/svg/angular.svg" width="64" alt="angular" class="transition group-hover:drop-shadow-[0_0_8px_rgba(59,130,246,0.5)] group-hover:drop-shadow-[0_0_16px_rgba(168,85,247,0.5)] group-hover:drop-shadow-[0_0_24px_rgba(244,114,182,0.6)]">
            <label for="angular" class="text-sm">Angular</label>
         </div>
         <div class="group flex flex-col items-center gap-1 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-700 py-4 w-[9rem] rounded-sm">
            ...
            <label for="vue" class="text-sm">VueJS</label>
         </div>
         <div class="group flex flex-col items-center gap-1 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-700 py-4 w-[9rem] rounded-sm">
            ...
            <label for="next" class="text-sm">NextJS</label>
         </div>                
      </div>
   </div>
`;
