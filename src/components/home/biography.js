            ...
            <div class="mt-6 grid lg:grid-cols-2 gap-5 md:gap-10 text-sm lg:text-left">
               ...
               <div class="space-y-6">
                  <div class="space-y-1">    
                     ...
                     <span class="text-base/7 text-balance">I record my gameplay and upload it to YouTube. I also create funny videos for Facebook, and I read manga and manhwa online. I also watch anime series like: One Piece, Blue Lock etc.</span>
                  </div>
                  <div class="space-y-1">    
