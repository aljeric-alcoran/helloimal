      ...
      <div class="h-dvh flex items-center justify-center md:justify-start">
         <div class="text-center md:text-left">
            ...
            <div class="flex items-center justify-center gap-2 mt-8 w-full">
               ...
               <button id="contact-me-btn" type="button" class="cursor-pointer text-[#3150CE] bg-[#3150CE]/10 hover:bg-[#3150CE]/15 border border-[#3150CE] hover:border-[#3150CE]/90 focus:ring-2 focus:outline-none focus:ring-[#3150CE]/50 font-medium rounded-sm text-sm px-4 py-2.5 text-center inline-flex items-center dark:focus:ring-[#3150CE]/55 gap-1">
...
const setHeroSection = (element) => {
   ...
   const downloadCVButton = document.getElementById('download-file-btn');
   downloadCVButton.addEventListener('click', () => downloadCV());

   const contactMeButton = document.getElementById('contact-me-btn');
   contactMeButton.addEventListener('click', () => scrollToSection('contact'));
};
